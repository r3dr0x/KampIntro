...
namespace LinqProject
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                new Product{ProductId = 1, CategoryId = 1, ProductName = "Acer Laptop", QuantityPerUnit = "31 GB Ram", UnitPrice=10000, UnitsInStock=5},
                ...
                new Product{ProductId = 15, CategoryId = 2, ProductName = "Apple Laptop", QuantityPerUnit = "4 GB Ram", UnitPrice=8000, UnitsInStock=0}
